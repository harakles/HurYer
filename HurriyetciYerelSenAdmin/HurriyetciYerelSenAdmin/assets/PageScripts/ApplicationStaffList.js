$(function () {
    window.dt = $("#datatable").DataTable({
        ...
        "ajax": {
            "url": "/Application/GetStaffList",
            "data": function (data) {

            }
        },
        "columns": [
            { "title": "Kadro", "data": "Staff", "searchable": true },
            {
                ...
                render: function (data, type, row) {
                    return `
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="/Application/StaffUpdate?id=${data.Id}">Düzenle</a>
...
function ApplicationDelete(id) {
    window.Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "/Application/StaffDelete?Id=" + id,
                type: "POST",
