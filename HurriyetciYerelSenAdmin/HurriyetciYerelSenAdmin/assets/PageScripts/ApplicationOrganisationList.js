$(function () {
    window.dt = $("#datatable").DataTable({
        ...
        "ajax": {
            "url": "/Application/GetOrganisationList",
            "data": function (data) {

            }
        },
        "columns": [
            { "title": "Kurum", "data": "OrganisationName", "searchable": true },
            {
                ...
                render: function (data, type, row) {
                    return `
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="/Application/OrganisationUpdate?id=${data.Id}">Düzenle</a>
...
function ApplicationDelete(id) {
    window.Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "/Application/OrganisationDelete?Id=" + id,
                type: "POST",
