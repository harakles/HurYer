$(function () {
    window.dt = $("#datatable").DataTable({
        ...
        "ajax": {
            "url": "/Application/GetEducationList",
            "data": function (data) {

            }
        },
        "columns": [
            { "title": "Eğitim", "data": "EducationName", "searchable": true },
            {
                ...
                render: function (data, type, row) {
                    return `
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="/Application/EducationUpdate?id=${data.Id}">Düzenle</a>
...
function ApplicationDelete(id) {
    window.Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "/Application/EducationDelete?Id=" + id,
                type: "POST",
