$(function () {
    window.dt = $("#datatable").DataTable({
        ...
        "ajax": {
            "url": "/Application/GetCaseList",
            "data": function (data) {

            }
        },
        "columns": [
            { "title": "Durum", "data": "Situation", "searchable": true },
            {
                ...
                render: function (data, type, row) {
                    return `
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="/Application/CaseUpdate?id=${data.Id}">Düzenle</a>
...
function ApplicationDelete(id) {
    window.Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "/Application/CaseDelete?Id=" + id,
                type: "POST",
